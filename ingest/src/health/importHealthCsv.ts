...
export const importHealthCsv = (db: AppDatabase, filePath: string, sourceName: string) => {
    ...
    rows.forEach((row, index) => {
      ...
      try {
        ...
        upsertCore.run(
          ...
          toNumberOrNull(readField(row, ['active_calories', 'calories'])),
          toNumberOrNull(readField(row, ['resting_heart_rate', 'resting_hr'])),
          toNumberOrNull(readField(row, ['hrv_ms', 'hrv'])),
          toNumberOrNull(readField(row, ['sleep_minutes'])),
          toNumberOrNull(readField(row, ['workout_minutes'])),
          toNumberOrNull(readField(row, ['body_weight_kg'])),
